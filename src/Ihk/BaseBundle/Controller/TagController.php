...
use Ihk\BaseBundle\Entity\Tag;
use Ihk\BaseBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IhkBaseBundle:Tag')->findAll();
     ...
     * @Method("POST")
     * @Template("IhkBaseBundle:Tag:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IhkBaseBundle:Tag')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IhkBaseBundle:Tag:edit.html.twig")
     */
	 ...
	 *
	 * @Route("/{id}/dishes", name="tag_show_dishes")
	 * @Method("GET")
	 * @Template("IhkBaseBundle:Tag:dishes.html.twig")
	 */
	public function showDishesAction($id)
	{
		$em = $this->getDoctrine()->getManager();

		$tag = $em->getRepository('IhkBaseBundle:Tag')->find($id);
		if (!$tag) {
			throw $this->createNotFoundException('Unable to find Tag entity.');
		}

		$dishes = $em->getRepository('IhkBaseBundle:Dish')->findByTagId($id);
		if (!$dishes) {
